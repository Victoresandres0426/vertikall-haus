-- ============================================================
-- 089 — Quitar desglose_periodos (quedó desalineado con el
--        modelo de umbral por renglón)
-- ============================================================
-- desglose_periodos venía de antes del modelo de umbral: partía el
-- período en sub-semanas usando avance_snapshots_semanales y calculaba
-- cada una como presupuesto_total × delta / 100 -- la fórmula del
-- modelo VIEJO (descuento parejo), que ya no tiene relación con los
-- montos reales que se están cobrando por renglón. Por eso se veían
-- "2026-09-08 al 2026-09-14 · $6,318.43" y "2026-09-15 · $0.00" que no
-- cuadraban con nada de la tabla de abajo.
--
-- Se deja de generar (queda '[]'::jsonb siempre) -- la tabla de
-- renglones ya es la fuente de verdad completa y consistente.
-- ============================================================
