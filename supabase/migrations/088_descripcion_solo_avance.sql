-- ============================================================
-- 088 — La descripción de la factura solo muestra el avance
--        (el detalle de amortización/indirectos/utilidad ya vive
--        en las columnas de la tabla de abajo, no hace falta
--        repetirlo arriba en texto)
-- ============================================================
-- Único cambio respecto a la 087: se quita del texto de descripción
-- la cláusula "· incluye $X de amortización de anticipo". El resto de
-- la función queda igual (modelo de umbral por renglón).
-- ============================================================
...
BEGIN
  ...
  LOOP
    ...
    -- Descripción simplificada: solo el avance del período y el
    -- acumulado. El detalle de amortización/indirectos/utilidad ya se
    -- ve en las columnas de la tabla del desglose, no hace falta
    -- repetirlo aquí en texto.
